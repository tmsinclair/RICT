...
Allpredictions <- read.csv("./output/test_file_multi-year_prediction.csv", as.is = TRUE)
...
write.csv(allResults_ntaxa_aspt_minta_combined, "./output/test_file_multi-year_classification.csv", row.names= FALSE)
